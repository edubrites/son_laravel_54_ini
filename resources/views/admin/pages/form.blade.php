...
<div class="form-group">
    <div class="col-sm-10 col-sm-offset-2 ">
        <input type="submit" value="salvar" class="btn btn-primary pull-left"> &nbsp;&nbsp;&nbsp;
        <a href="{{ isset($page->id) ? route('pages.show', $page->id) : route('pages.index')}}" class="btn btn-primary ">Cancelar</a>
    </div>
</div>